    ...
    <div>
      <Contenedorhome>
        <Carousel {...carouselSettings}>
          <Imagecontainer>
            <img className="animation-img" src={desierto} alt="" />
            <div className="paragraph">Live the adventure</div>
          ...
          <div>
            <Imagecontainer>
              <img className="animation-img" src={Cascada} alt="" />
              <div className="paragraph">Live the adventure</div>
              <div className="wordimg">
                <p>
                  Discover <br />
          ...
          <div>
            <Imagecontainer>
              <img className="animation-img" src={bosqueestrella} alt="" />
              <div className="paragraph">Live the adventure</div>
              <div className="wordimg">
                <p>
                  Discover <br />
